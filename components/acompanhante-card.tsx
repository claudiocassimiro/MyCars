...
export function AcompanhanteCard({
  acompanhante,
  featured = false,
}: AcompanhanteCardProps) {
  return (
    <Card
      className={`overflow-hidden shadow-luxury hover:shadow-xl transition-all duration-300 bg-white border-red-100 ${
    ...
    >
      ...
      <CardContent className="p-4">
        ...
        <div className="mb-4 text-xs text-gray-500">
          <p>
            <span className="font-semibold">Cabelo:</span>{" "}
            {acompanhante.caracteristicas.cabelo}
          </p>
          <p>
            <span className="font-semibold">Altura:</span>{" "}
            {acompanhante.caracteristicas.altura}
          </p>
        </div>
